...
import 'package:toko_voucher_wifi/Components/title_text.dart';
                ...
                ? GridView.builder(
                    ...
                    itemBuilder: (context, index) {
                      return _productCard(
                          ...
                          "$baseUrl/public/images/${dataBarang[index]['gambar']}",
                          dataBarang[index]['kategoriBarang']['namaKategori'],
                          CurrencyFormat.convertToIdr(
                              dataBarang[index]['harga'], 0),
                          dataBarang[index]);
                    },
                ...
                : GridView.builder(
                    ...
                    itemBuilder: (context, index) {
                      return _productCard(
                          ...
                          // "assets/images/ibanez_product.jpg",
                          "$baseUrl/public/images/${_foundBarang[index]['gambar']}",
                          _foundBarang[index]['kategoriBarang']['namaKategori'],
                          CurrencyFormat.convertToIdr(
                              _foundBarang[index]['harga'], 0),
                          dataBarang[index]);
                    },
                    gridDelegate: SliverGridDelegateWithFixedCrossAxisCount(
                        crossAxisCount: 2,
