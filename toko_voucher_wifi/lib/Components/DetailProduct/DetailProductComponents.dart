...
import 'package:toko_voucher_wifi/Components/extentions.dart';
  ...
  Widget _productImage() {
    return AnimatedBuilder(
      ...
      child: Stack(
        ...
        children: <Widget>[
          Image.network(
              "$baseUrl/public/images/${DetailProductscreens.dataBarang['gambar']}",
              height: 310,
              width: 310,
              fit: BoxFit.cover)
        ],
                            ...
                            children: <Widget>[
                              ...
                              /*TitleText(
                                text: CurrencyFormat.convertToIdr(
                                    DetailProductscreens.dataBarang['harga'], 0),
                                fontSize: 14,
                              ),*/
                            ],
                          ),
  ...
  Widget _description() {
    return Column(
      ...
      children: <Widget>[
        TitleText(
          color: kPrimaryColor,
          text: DetailProductscreens.dataBarang['kategoriBarang']['namaKategori'].toString(),
          fontSize: 14,
        ),
        SizedBox(height: 7),
        TitleText(
          text: CurrencyFormat.convertToIdr(
            ...
            TitleText(
          color: kColorGreenDarker,
          text: 'Sisa stok: '+DetailProductscreens.dataBarang['stok'].toString()+' pcs',
          fontSize: 14,
        ),
        SizedBox(height: 13),
